...
<head>
	...
	<title>Consumption Graphs</title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Consumption Graphs</a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <center><iframe src="highchart/<?php echo($g)?>" height=900px width=100% ></iframe> </center>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <center><iframe src="highchart/weekly.html" height=420px width=60% ></iframe> </center>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <center><iframe src="highchart/chart.html" height=420px width=60% ></iframe> </center>
                        </div>
                    </div>
