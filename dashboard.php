                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <center><iframe src="highchart/<?php echo($g)?>" height=800px width=100% ></iframe> </center>
...
{
$g =$i.$v;
$q="SELECT ".$g." from chetan WHERE appliance='totalhr'";
...
echo("<tr>
                                                ...
                                                <td>"."This is an alert to notify that you have consumed ".$e." watts in ".$i." hr"."</td>"
 );
}
}
for($i=0;$i<12;$i++)
{
$g =$i.$v;
$q="SELECT ".$g." from ".$naam." WHERE appliance='totalhr'";
$result=mysqli_query($conn,$q);
if ($result->num_rows > 0) {
$row=$result->fetch_assoc();
$e=$row[$g];
